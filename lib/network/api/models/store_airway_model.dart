...
class StoreAirwayModel {
  StoreAirwayModel({
    this.responseCode,
    this.message,
    this.response,});

  StoreAirwayModel.fromJson(dynamic json) {
    responseCode = json['responseCode'];
    message = json['message'];
    response = json['response'] != null ? StoreAirwayMainData.fromJson(json['response']) : null;
  }
  num? responseCode;
  String? message;
  StoreAirwayMainData? response;
...
class StoreAirwayMainData {
  ...
  StoreAirwayMainData.fromJson(dynamic json) {
    userId = json['userId'];
    awbNbr = json['awbNbr'];
